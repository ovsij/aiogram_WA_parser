...
def inline_kb_howto():
    text = markdown.text(
        ...
        markdown.bold('Важно!'),
        '• Мы принимаем оплату картами платежных систем Visa, Mastercard, МИР\.',
        ...
        '• Сроки и способы доставки товара согласовываются индивидуально с каждым покупателем при оформлении заказа\.'
        'Если вы обратились к нашим менеджерам лично и выбранные вами категории товаров подходят под индивидуальную доставку, то при заказе от определенной суммы доставка бесплатная\. Во всех остальных случаях индивидуальная доставка — от 40€\.',
